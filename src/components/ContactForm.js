        ...
        <div className='contact_form_main_container'>
            <div className='contact_form_container'>
                ...
                <div className='name_and_email_container1'>
                    ...
                    <input type="text" id="username" name="username" placeholder='Krzysztof' />
                    <hr></hr>
                </div>
                <div className='name_and_email_container2'>
                    <label htmlFor="email">Wpisz swój email:</label>
                    <input type="text" id="email" name="email" placeholder='abc@xyz.pl' />
                    <hr></hr>
                </div>
                    <div className='msg_container'>
                        <label htmlFor="messeage">Wpisz swoją wiadomość:</label>
                        <textarea id="messeage" name="messeage" placeholder='Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.'/>
                        <hr></hr>
                    </div>
                </div>
